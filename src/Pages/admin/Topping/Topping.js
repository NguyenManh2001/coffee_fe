...
function ToppingAdmin() {
    ...
    const handldeDelete = (id) => {
        confirm({
            ...
            onOk() {
                axios
                    .delete(`https://coffee-bills.onrender.com/topping/deleteTopping/${id}`)
                    .then((res) => {
    ...
    const { isLoading, data, refetch } = useQuery({
        ...
        queryFn: () =>
            axios
                .post('https://coffee-bills.onrender.com/topping/listTopping', { page, type, search })
                .then((res) => res.data),
    });
            ...
            <div className={cx('Container')}>
                <div className={cx('header')}>
                    ...
                    <div className={cx('btnHeader')}>
                        <Link to={config.routers.AddTopping} className={cx('btnIconAdd')}>
