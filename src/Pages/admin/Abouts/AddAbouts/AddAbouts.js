...
import styles from './AddAbouts.module.scss';
...
function AddAbouts() {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await axios
            .post('https://coffee-bills.onrender.com/abouts/AddAbouts', uploadData)
            .then((res) => {
                navigate(config.routers.AboutsAdmin, { state: { successMessage: 'Bạn đã thêm thành công!!!' } });
            })
            .catch((err) => {
                console.log('loi');
            });
