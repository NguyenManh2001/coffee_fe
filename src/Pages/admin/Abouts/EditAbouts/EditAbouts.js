...
import styles from './EditAbouts.module.scss';
...
function EditNews(props) {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await axios
            .put(`https://coffee-bills.onrender.com/abouts/editAbouts/${data._id}`, uploadData)
            .then((res) => {
                navigate(config.routers.AboutsAdmin, { state: { successMessage: 'Bạn đã cập nhật thành công!!!' } });
            })
            .catch((err) => {
                console.log('loi');
            });
