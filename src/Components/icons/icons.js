...
export const AddIcons = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <path fill="none" stroke="#fff" strokeWidth="2" d="M12,22 L12,2 M2,12 L22,12"></path>
    </svg>
);
export const CoffeeIcons = ({ width = '2rem', height = '2rem', className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" height="1em" style={{ marginRight: '14px' }} viewBox="0 0 512 512">
        <path
            fill="#625d5dfc"
